                           ...
                           <div class="row">
                            <div class="col-md-6">
                              <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                 <input type="text" class="form-control" placeholder="Rusizi" >
                                </div>
                              </div>
                              </div>
                            <div class="col-md-6">
                              <div class="form-group row">
                               <label class="col-sm-4 col-form-label">CurrentCommunity</label>
                                <div class="col-sm-8">
                                  <input type="text" placeholder="Kigali" class="form-control">
                                </div>
                                </div>
                              </div>
                           </div>
                           ...
                           <div class="row">
                            <div class="col-md-6">
                              <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                 <input type="phone" class="form-control" placeholder="Eg:0787124101" >
                                </div>
                              </div>
                              </div>
                            <div class="col-md-6">
                              <div class="form-group row">
                               <label class="col-sm-4 col-form-label">Country</label>
                                <div class="col-sm-8">
                                  <input type="text" placeholder="Eg:Rwanda" class="form-control">
                                </div>
                                </div>
                              </div>
                           </div>
                           <div class="row">
                            <div class="col-md-6">
                              <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                 <input type="phone" class="form-control" placeholder="Eg:West" >
                                </div>
                              </div>
                              </div>
                            <div class="col-md-6">
                              <div class="form-group row">
                               <label class="col-sm-4 col-form-label">District</label>
                                <div class="col-sm-8">
                                  <input type="text" placeholder="Eg:Rusizi" class="form-control">
                                </div>
                                </div>
                              </div>
                           </div>
                           <div class="row">
                            <div class="col-md-6">
                              <div class="form-group row">
                                ...
                                <div class="col-sm-8">
                                 <input type="text" class="form-control" placeholder="Eg:Gitambi" >
                                </div>
                              </div>
                              </div>
                            <div class="col-md-6">
                              <div class="form-group row">
                               <label class="col-sm-4 col-form-label">Cell</label>
                                <div class="col-sm-8">
                                  <input type="text" placeholder="Eg:Mashesha" class="form-control">
                                </div>
                                </div>
                              </div>
                           </div>
                            ...
                            <div class="col-md-6">
                              <div class="form-group row">
                               <label class="col-sm-4 col-form-label">Village</label>
                                <div class="col-sm-8">
                                  <input type="text" placeholder="karama" class="form-control">
                                </div>
                                </div>
                              </div>
                           </div>
                        ...
                        <div class="row">
                         ...
                         <div class="float-right mb-2">
                          <button type="submit"  color="accent" class="btn btn-success">Cancel</button>
                             <button  color="primary" class="btn btn-primary ml-4 ">
                              Save
                            </button>
                          </div>
                         </div>
