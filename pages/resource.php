...
<body>
    ...
    <div class="images pt-5" style="background-color: #f6fafd;">
      <div class="row justify-content-center mb-5">
            <div class="col-md-12 heading-section text-center ">
              <span class="subheading">SU Rwanda Resource </span><br>
              <span class="h3 mt-5">God's big story transforming young lives </span>
             </div>
      </div>
    </div>
</section>
 <section class="mb-160">
    ...
    <section class="row pt-5">
        <div class="grid-last_col col-sm-6 pt-5">
              <h3 class="h3 mb-05em"> Library </h3>
              <div class=" typo-tiny text-body-1 color-secondary mb-1em">
                  <p><span style="font-weight: 400;">One of the rooms of the Peter Guillebaud Foundation building is used as a library. Pastors, evangelists and other interested people may use the resources there to increase their knowledge and understanding by reading Christian books or using the internet. The library is also useful for promoting the Christian literature in our bookshop.</span></p>
              </div>
            </div> 
         <div class="grid-last_col col-sm-6">
                <div><img class="img" src="../images/SU/Bible Ministries/library.jpg" width="700" height="400"></div>
          </div>
    </section>
    </div>
  </section>  
